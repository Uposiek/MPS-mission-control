...
function renderGarage(){
 renderIssues();renderTyres();renderParts();renderDocuments()
}
...
if("serviceWorker" in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("sw-v61.js").catch(()=>{}));
