...
(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    // v6.3 Documents / Driving Licence
    "ISSUES // TYRES // PARTS // DOCUMENTS // LICENCE": "PROBLEMY // OPONY // CZĘŚCI // DOKUMENTY // PRAWO JAZDY",
    "DRIVING LICENCE": "PRAWO JAZDY",
    "VALID UNTIL": "WAŻNE DO",
    "TIME LEFT": "POZOSTAŁO",
    "EDIT DRIVING LICENCE": "EDYTUJ PRAWO JAZDY",
    "Track the expiry date of your driving licence.": "Pilnuj daty ważności prawa jazdy.",
    "NO DATE": "BRAK DATY",
    "VALID": "WAŻNE",
    "EXPIRED": "NIEWAŻNE",
    "Expiry date required.": "Data ważności jest wymagana.",
    "Driving licence saved.": "Prawo jazdy zapisane.",
    // v7.0 AUTO / vehicle / tyres
    "CAR CONTROL": "AUTO",
    "VEHICLE // DOCUMENTS // CAR HEALTH": "POJAZD // DOKUMENTY // STAN AUTA",
    "CAR HEALTH": "STAN AUTA",
    "STATUS": "STATUS",
    "TYRE ROTATION": "PRZEKŁADKA OPON",
    "NEXT DOCUMENT": "NAJBLIŻSZY DOKUMENT",
    "VEHICLE DATA": "DANE POJAZDU",
    "IDENTITY": "DANE",
    ...
    "PURCHASE ODO": "PRZEBIEG PRZY ZAKUPIE",
    "PURCHASE ODO [KM]": "PRZEBIEG PRZY ZAKUPIE [KM]",
    "EDIT VEHICLE DATA": "EDYTUJ DANE POJAZDU",
    "VIN, registration and basic vehicle identity.": "VIN, numer rejestracyjny i podstawowe dane pojazdu.",
    "Vehicle data saved.": "Dane pojazdu zapisane.",
    "MISSION ARCHIVE": "ARCHIWUM MISJI",
    "ARCHIVED": "ARCHIWUM",
    "Pickup": "Odbiór",
    "Full countdown remains available as archive.": "Pełne odliczanie pozostaje dostępne w archiwum.",
    "Rebuild countdown is still active.": "Odliczanie remontu nadal jest aktywne.",
    "OPEN MISSION CONTROL": "OTWÓRZ MISSION CONTROL",
    "AUTO // DOCUMENTS": "AUTO // DOKUMENTY",
    "← BACK TO AUTO": "← WRÓĆ DO AUTO",
    "OIL // TYRES // MAINTENANCE // UPCOMING": "OLEJ // OPONY // OBSŁUGA // NADCHODZĄCE",
    "TYRES // FRONT ↔ REAR": "OPONY // PRZÓD ↔ TYŁ",
    "TOTAL SET MILEAGE": "PRZEBIEG KOMPLETU",
    "SINCE ROTATION": "OD PRZEKŁADKI",
    "TO ROTATION": "DO PRZEKŁADKI",
    "EST. ROTATION": "SZAC. PRZEKŁADKA",
    "FRONT": "PRZÓD",
    "REAR": "TYŁ",
    "TREAD": "BIEŻNIK",
    "↕ ROTATE FRONT ↔ REAR": "↕ PRZEŁÓŻ PRZÓD ↔ TYŁ",
    "TYRE SETS": "KOMPLETY OPON",
    "EDIT / SWITCH": "EDYCJA / ZMIANA",
    "ROTATION HISTORY": "HISTORIA PRZEKŁADEK",
    "FRONT PAIR NAME": "NAZWA PARY Z PRZODU",
    "REAR PAIR NAME": "NAZWA PARY Z TYŁU",
    "FRONT TREAD [MM]": "BIEŻNIK PRZÓD [MM]",
    "REAR TREAD [MM]": "BIEŻNIK TYŁ [MM]",
    "ROTATION INTERVAL [KM]": "INTERWAŁ PRZEKŁADKI [KM]",
    "FRONT TREAD BEFORE ROTATION [MM]": "BIEŻNIK PRZÓD PRZED PRZEKŁADKĄ [MM]",
    "REAR TREAD BEFORE ROTATION [MM]": "BIEŻNIK TYŁ PRZED PRZEKŁADKĄ [MM]",
    "ROTATE FRONT ↔ REAR": "PRZEŁÓŻ PRZÓD ↔ TYŁ",
    "Records mileage and swaps the two axle pairs.": "Zapisuje przebieg i zamienia pary między osiami.",
    "Tyres rotated front ↔ rear.": "Opony przełożone przód ↔ tył.",
    "No active tyre set.": "Brak aktywnego kompletu opon.",
    "Activate this tyre set first.": "Najpierw aktywuj ten komplet opon.",
    "Mileage and front/rear rotation are tracked while a set is active.": "Przebieg i przekładki przód/tył są liczone, gdy komplet jest aktywny.",
    "TYRE ROTATION": "PRZEKŁADKA OPON",
    "DEFAULT ROTATION INTERVAL [KM]": "DOMYŚLNY INTERWAŁ PRZEKŁADKI [KM]",
    "SAVE TYRE SETTINGS": "ZAPISZ USTAWIENIA OPON",
    "Tyre rotation settings saved.": "Ustawienia przekładki opon zapisane.",
    "Interval must be > 0.": "Interwał musi być większy od 0.",
    "DUE NOW": "TERAZ",
    "ADD MORE ODO HISTORY": "DODAJ WIĘCEJ HISTORII PRZEBIEGU",
    "NO ACTIVE SET": "BRAK AKTYWNEGO KOMPLETU",
    "NO BASELINE": "BRAK BAZY",
    "NO DOCUMENTS": "BRAK DOKUMENTÓW",
    "URGENT ISSUE": "PILNY PROBLEM",
    "OPEN / OBSERVING": "OTWARTE / OBSERWACJA",
    "NONE": "BRAK",
    "NO UPCOMING": "BRAK NADCHODZĄCYCH",
    "ATTENTION": "UWAGA",
    "CHECK": "SPRAWDŹ",
    "OK": "OK",
    "ISSUES // BUILD SHEET // PARTS": "PROBLEMY // BUILD SHEET // CZĘŚCI",
    // v7.0 Build Sheet Polish names
    "OEM timing kit (VVT, chain, tensioner, 2 guides)": "Rozrząd OEM (VVT, łańcuch, napinacz, 2 ślizgi)",
    "Valve cover gasket": "Uszczelka pokrywy zaworów",
    "Crankshaft seal": "Uszczelniacz wału",
    "VVT seal": "Uszczelniacz VVT",
    "Crank pulley bolt": "Śruba koła pasowego",
    "Valvoline SynPower 5W40 — final oil": "Valvoline SynPower 5W40 — olej docelowy",
    "Oil filter x3": "Filtr oleju x3",
    "Gearbox oil": "Olej do skrzyni biegów",
    "Cleaning materials": "Środki czyszczące",
    "Coolant": "Płyn chłodniczy",
    "Cylinder head rebuild": "Regeneracja głowicy",
    "Block sleeving": "Tulejowanie bloku",
    "Piston machining for forged rods": "Frez tłoków pod kute korby",
    "Forged connecting rods": "Kute korby",
    "Piston rings": "Pierścienie tłokowe",
    "Cylinder head bolts": "Śruby głowicy",
    "Clutch regeneration": "Regeneracja sprzęgła",
    "Crankshaft support bolts": "Śruby podpory wału",
    "Oil pump": "Pompa oleju",
    "Oil pickup": "Smok olejowy",
    "ACL Race main bearings": "Panewki główne ACL Race",
    "Cylinder head gasket": "Uszczelka pod głowicę",
    "Rear crankshaft seal — gearbox side": "Uszczelniacz wału od strony skrzyni",
    "First-start oil 10W40": "Olej na pierwsze odpalenie 10W40",
    "Break-in oil": "Olej na dotarcie",
    "A/C recharge": "Nabicie klimatyzacji",
    "Exhaust manifold gasket": "Uszczelka kolektora wydechowego",
    "Power steering fluid": "Płyn wspomagania",
    "Oil filter housing gasket": "Uszczelka podstawy filtra oleju",
    "Balance delete kit": "Balance delete kit",
    "ACL Race rod bearings": "Panewki korbowodowe ACL Race",
    "Injector regeneration": "Regeneracja wtrysków",
    "D4D injector washers": "Podkładki pod wtryski D4D",
    "Breather plate gasket": "Uszczelka płytki odmy",
    "PCV valve gasket": "Uszczelka pod zaworek PCV",
    "Intake manifold gasket": "Uszczelka kolektora ssącego",
    "Thermostat": "Termostat",
    "Oil pump drive": "Napęd pompy oleju",
    "Water pump": "Pompa wody",
    "Coolant rail gasket": "Uszczelka magistrali wodnej",
    "HPFP pump gasket": "Uszczelka pod pompę HPFP",
    "Long downpipe": "Długi downpipe",
    "HPFP internals": "Wkład pompy HPFP",
    "3\" intake": "Dolot 3\"",
    "DISI tuning": "Strojenie DISI",
    "Turbocharger": "Turbo",
    "EBCS": "EBCS",
    "52 mm oil temperature gauge": "Zegar temperatury oleju 52 mm",
    "Sensor adapter": "Podstawka pod czujnik",
    "Break-in fuel": "Paliwo na dotarcie",
    "Engine removal, teardown, assembly and installation": "Wymontowanie, rozłożenie, złożenie i zamontowanie silnika",
    "Oil temperature gauge installation": "Montaż zegara temperatury oleju",
    "Wheel alignment": "Zbieżność",
    // Storage
    // v6.2 Build Sheet
    "2026 REBUILD // BUILD SHEET": "REMONT 2026 // BUILD SHEET",
    "WORKSHOP LIST // NET VALUES": "LISTA WARSZTATU // KWOTY NETTO",
    "PARTS + MACHINING": "CZĘŚCI + OBRÓBKA",
    "LABOR": "ROBOCIZNA",
    "TOTAL NET": "RAZEM NETTO",
    "DEPOSIT": "ZALICZKA",
    "BALANCE AFTER DEPOSIT": "POZOSTAŁO PO ZALICZCE",
    "ALL CATEGORIES": "WSZYSTKIE KATEGORIE",
    "ALL STATUS": "WSZYSTKIE STATUSY",
    "TIMING": "ROZRZĄD",
    "MACHINING / REGENERATION": "OBRÓBKA / REGENERACJA",
    "MACHINING": "OBRÓBKA",
    "SEALS / GASKETS": "USZCZELNIENIA / USZCZELKI",
    "SEALS": "USZCZELNIENIA",
    "MATERIALS": "MATERIAŁY",
    "COOLING": "CHŁODZENIE",
    ...
    "REMOVED": "USUNIĘTE",
    "SHOW BUILD SHEET": "POKAŻ LISTĘ REMONTU",
    "HIDE BUILD SHEET": "UKRYJ LISTĘ REMONTU",
    "EXPORT CSV": "EKSPORTUJ CSV",
    "MARK ALL AS INSTALLED": "OZNACZ WSZYSTKO JAKO ZAMONTOWANE",
    "＋ ADD BUILD ITEM": "＋ DODAJ POZYCJĘ REMONTU",
    "BUILD SHEET ITEM": "POZYCJA LISTY REMONTU",
    "2026 rebuild record // net values.": "Dokumentacja remontu 2026 // kwoty netto.",
    "ITEM NAME": "NAZWA POZYCJI",
    "TYPE": "TYP",
    "BRAND / SPEC": "MARKA / SPECYFIKACJA",
    "NET PRICE [PLN]": "CENA NETTO [PLN]",
    "PARTS / MACHINING": "CZĘŚCI / OBRÓBKA",
    "EDIT BUILD SHEET ITEM": "EDYTUJ POZYCJĘ REMONTU",
    "NO MATCHING ITEMS": "BRAK PASUJĄCYCH POZYCJI",
    "Build sheet item saved.": "Pozycja listy remontu zapisana.",
    "Net price must be >= 0.": "Cena netto nie może być ujemna.",
    "Build sheet marked as installed.": "Lista remontu oznaczona jako zamontowana.",
    "Mark all current build-sheet items as INSTALLED?": "Oznaczyć wszystkie bieżące pozycje listy remontu jako ZAMONTOWANE?",
  ...
  const patterns = [
    ...
    [/^(\d+) KM SINCE PREVIOUS$/i, "$1 KM OD POPRZEDNIEJ"],
    [/^(\d[\d\s,.]*) OVER$/i, "$1 PO TERMINIE"],
  ...
  const attrMap = new Map(Object.entries({
    ...
    "Search rebuild: BNR, ACL, OEM, oil pump...": "Szukaj remontu: BNR, ACL, OEM, pompa oleju..."
  }));
  ...
  function translateString(input) {
    ...
    const tokens = [
      ...
      [" // INSPECTION", " // KONTROLA"],
      [" // OTHER", " // INNE"],
      [" KM LOGGED", " KM PRZEBIEGU"],
      [" // ROTATION ", " // PRZEKŁADKA "],
      [" KM/DAY", " KM/DZIEŃ"],
      [" KM INTERVAL", " KM INTERWAŁ"]
    ];
