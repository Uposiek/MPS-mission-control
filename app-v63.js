...
function renderGarage(){
 renderIssues();renderTyres();renderBuildSheet();renderParts();renderDocuments();renderDrivingLicence()
}
...
if("serviceWorker" in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("sw-v63.js").catch(()=>{}));
